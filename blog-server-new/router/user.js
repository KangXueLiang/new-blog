...
import {MD5_SUFFIX, MD5, SECRET_KEY, responseClient} from '../tools/constant';
  ...
  try {
    await User.findOne({
      ...
      if (user !== null) {
        ...
        responseClient(res, 200, 0, 'Password has been modified!')
      } else {
        responseClient(res, 401, -1, 'Email and password do not match')
      }
    });
  } catch (e) {
    res.json(e.message);
